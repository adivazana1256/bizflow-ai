...
export default function SimulatorChat({ businessName }: { businessName: string }) {
  ...
  return (
    <div className="mx-auto max-w-md">
      ...
      <div className="flex h-[70vh] flex-col overflow-hidden rounded-lg border border-gray-300">
        <div className="bg-emerald-700 px-4 py-2 text-sm font-medium text-white">{businessName}</div>
